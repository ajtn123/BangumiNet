...
namespace BangumiNet.Api.V0
{
    public partial class ApiClient : IApiClient
    {
        ...
        public const string DefinitionUrl = "https://github.com/bangumi/api/blob/master/open-api/v0.yaml";
...
namespace BangumiNet.Api.Legacy
{
    public partial class ApiClient : IApiClient
    {
        ...
        /// <summary>OpenAPI 定义文件的 URL</summary>
        public const string DefinitionUrl = "https://github.com/bangumi/api/blob/master/open-api/api.yml";
        /// <summary>生成本 API 客户端的命令</summary>
