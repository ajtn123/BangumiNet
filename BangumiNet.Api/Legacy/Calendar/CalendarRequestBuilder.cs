...
namespace BangumiNet.Api.Legacy.Calendar
{
    ...
    public partial class CalendarRequestBuilder : BaseRequestBuilder
    {
        ...
        /// 每日放送
        /// </summary>
        /// <returns>A List&lt;global::BangumiNet.Api.Legacy.Calendar.Calendar&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::BangumiNet.Api.Legacy.Calendar.Calendar>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::BangumiNet.Api.Legacy.Calendar.Calendar>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.Legacy.Calendar.CalendarRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.Legacy.Calendar.CalendarRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.Legacy.Calendar.CalendarRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
