...
namespace BangumiNet.Api.Legacy.Calendar
{
    ...
    public partial class Calendar : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.Legacy.Calendar.Calendar"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::BangumiNet.Api.Legacy.Calendar.Calendar CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "items", n => { Items = n.GetCollectionOfObjectValues<global::BangumiNet.Api.Legacy.Models.Legacy_SubjectSmall>(global::BangumiNet.Api.Legacy.Models.Legacy_SubjectSmall.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::BangumiNet.Api.Legacy.Models.Legacy_SubjectSmall>("items", Items);
            writer.WriteObjectValue<global::BangumiNet.Api.Legacy.Calendar.Calendar_weekday>("weekday", Weekday);
