...
using BangumiNet.Api.V0.V0.Episodes.Item;
...
using System;
namespace BangumiNet.Api.V0.V0.Episodes
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the BangumiNet.Api.V0.v0.episodes.item collection</summary>
        /// <param name="position">章节 ID</param>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.V0.Episodes.Item.WithEpisode_ItemRequestBuilder"/></returns>
        public global::BangumiNet.Api.V0.V0.Episodes.Item.WithEpisode_ItemRequestBuilder this[int position]
        {
            get
            {
        ...
        public global::BangumiNet.Api.V0.V0.Episodes.Item.WithEpisode_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// Get Episodes
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.Models.Paged_Episode"/></returns>
...
#nullable enable
        public async Task<global::BangumiNet.Api.V0.Models.Paged_Episode?> GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.V0.V0.Episodes.EpisodesRequestBuilder.EpisodesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.V0.Models.Paged_Episode> GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.V0.V0.Episodes.EpisodesRequestBuilder.EpisodesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BangumiNet.Api.V0.V0.Episodes.EpisodesRequestBuilder.EpisodesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BangumiNet.Api.V0.V0.Episodes.EpisodesRequestBuilder.EpisodesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.V0.Episodes.EpisodesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.V0.V0.Episodes.EpisodesRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class EpisodesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::BangumiNet.Api.V0.V0.Episodes.EpisodesRequestBuilder.EpisodesRequestBuilderGetQueryParameters>
        {
        }
    }
}
