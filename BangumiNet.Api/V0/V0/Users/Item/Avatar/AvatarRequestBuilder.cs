...
using System;
namespace BangumiNet.Api.V0.V0.Users.Item.Avatar
{
    /// <summary>
...
#nullable enable
        public async Task GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.V0.V0.Users.Item.Avatar.AvatarRequestBuilder.AvatarRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.V0.V0.Users.Item.Avatar.AvatarRequestBuilder.AvatarRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BangumiNet.Api.V0.V0.Users.Item.Avatar.AvatarRequestBuilder.AvatarRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BangumiNet.Api.V0.V0.Users.Item.Avatar.AvatarRequestBuilder.AvatarRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.V0.Users.Item.Avatar.AvatarRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.V0.V0.Users.Item.Avatar.AvatarRequestBuilder WithUrl(string rawUrl)
        {
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AvatarRequestBuilderGetRequestConfiguration : RequestConfiguration<global::BangumiNet.Api.V0.V0.Users.Item.Avatar.AvatarRequestBuilder.AvatarRequestBuilderGetQueryParameters>
        {
        }
    }
}
