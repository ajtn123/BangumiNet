...
using System;
namespace BangumiNet.Api.V0.V0.Indices.Item.Collect
{
    /// <summary>
    ...
    public partial class CollectRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::BangumiNet.Api.V0.Models.ErrorDetail">When receiving a 500 status code</exception>
        public async Task<Stream?> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "500", global::BangumiNet.Api.V0.Models.ErrorDetail.CreateFromDiscriminatorValue },
            };
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.V0.Indices.Item.Collect.CollectRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.V0.V0.Indices.Item.Collect.CollectRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.V0.V0.Indices.Item.Collect.CollectRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
