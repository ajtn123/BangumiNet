...
using System;
namespace BangumiNet.Api.V0.V0.Revisions.Characters.Item
{
    /// <summary>
    ...
    public partial class WithRevision_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.Models.CharacterRevision"/></returns>
        ...
        public async Task<global::BangumiNet.Api.V0.Models.CharacterRevision?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.V0.V0.Revisions.Characters.Item.WithRevision_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.V0.V0.Revisions.Characters.Item.WithRevision_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
