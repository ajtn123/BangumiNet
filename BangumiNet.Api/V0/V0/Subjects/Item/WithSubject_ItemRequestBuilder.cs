...
using BangumiNet.Api.V0.V0.Subjects.Item.Characters;
using BangumiNet.Api.V0.V0.Subjects.Item.Image;
using BangumiNet.Api.V0.V0.Subjects.Item.Persons;
using BangumiNet.Api.V0.V0.Subjects.Item.Subjects;
...
using System;
namespace BangumiNet.Api.V0.V0.Subjects.Item
{
    /// <summary>
...
#nullable enable
        public async Task<global::BangumiNet.Api.V0.Models.Subject?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.V0.Models.Subject> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.V0.V0.Subjects.Item.WithSubject_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.V0.V0.Subjects.Item.WithSubject_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
