...
using System;
namespace BangumiNet.Api.V0.V0.Subjects.Item.Characters
{
    /// <summary>
    ...
    public partial class CharactersRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A List&lt;global::BangumiNet.Api.V0.Models.RelatedCharacter&gt;</returns>
...
#nullable enable
        public async Task<List<global::BangumiNet.Api.V0.Models.RelatedCharacter>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::BangumiNet.Api.V0.Models.RelatedCharacter>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.V0.Subjects.Item.Characters.CharactersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.V0.V0.Subjects.Item.Characters.CharactersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.V0.V0.Subjects.Item.Characters.CharactersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
