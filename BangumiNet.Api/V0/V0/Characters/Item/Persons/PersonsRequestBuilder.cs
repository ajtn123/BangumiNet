...
using System;
namespace BangumiNet.Api.V0.V0.Characters.Item.Persons
{
    /// <summary>
    ...
    public partial class PersonsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A List&lt;global::BangumiNet.Api.V0.Models.CharacterPerson&gt;</returns>
        ...
        public async Task<List<global::BangumiNet.Api.V0.Models.CharacterPerson>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.V0.Characters.Item.Persons.PersonsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.V0.V0.Characters.Item.Persons.PersonsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.V0.V0.Characters.Item.Persons.PersonsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
