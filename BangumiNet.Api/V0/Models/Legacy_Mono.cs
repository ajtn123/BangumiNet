...
namespace BangumiNet.Api.V0.Models
{
    ...
    public partial class Legacy_Mono : global::BangumiNet.Api.V0.Models.Legacy_MonoBase, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.V0.Models.Legacy_Mono"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::BangumiNet.Api.V0.Models.Legacy_Mono CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::BangumiNet.Api.V0.Models.Legacy_Mono();
        }
