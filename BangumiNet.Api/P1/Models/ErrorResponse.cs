...
namespace BangumiNet.Api.P1.Models
{
    ...
    public partial class ErrorResponse : ApiException, IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.Models.ErrorResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::BangumiNet.Api.P1.Models.ErrorResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
