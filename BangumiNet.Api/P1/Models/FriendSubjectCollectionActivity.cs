...
namespace BangumiNet.Api.P1.Models
{
    ...
    public partial class FriendSubjectCollectionActivity : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>收藏最后修改时间，unix time stamp in seconds</summary>
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::BangumiNet.Api.P1.Models.FriendSubjectCollectionActivity"/> and sets the default values.
        /// </summary>
        public FriendSubjectCollectionActivity()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.Models.FriendSubjectCollectionActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::BangumiNet.Api.P1.Models.FriendSubjectCollectionActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::BangumiNet.Api.P1.Models.FriendSubjectCollectionActivity();
        }
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "collectionType", n => { CollectionType = n.GetIntValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteIntValue("collectionType", CollectionType);
