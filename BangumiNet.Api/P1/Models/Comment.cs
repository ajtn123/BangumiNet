...
namespace BangumiNet.Api.P1.Models
{
    ...
    public partial class Comment : global::BangumiNet.Api.P1.Models.CommentBase, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.Models.Comment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::BangumiNet.Api.P1.Models.Comment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::BangumiNet.Api.P1.Models.Comment();
        }
