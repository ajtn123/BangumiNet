...
using BangumiNet.Api.P1.P1.Groups.Posts;
using BangumiNet.Api.P1.P1.Groups.Topics;
...
namespace BangumiNet.Api.P1.P1.Groups
{
    ...
    public partial class Minus_RequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Minus_RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/p1/groups/-", rawUrl)
        {
        }
    }
}
