...
namespace BangumiNet.Api.P1.P1.Blogs.Comments.Item
{
    ...
    public partial class WithCommentItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public async Task<global::BangumiNet.Api.P1.P1.Blogs.Comments.Item.WithCommentDeleteResponse?> DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::BangumiNet.Api.P1.Models.ErrorResponse">When receiving a 500 status code</exception>
        public async Task<global::BangumiNet.Api.P1.P1.Blogs.Comments.Item.WithCommentPutResponse?> PutAsync(global::BangumiNet.Api.P1.Models.UpdateContent body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
