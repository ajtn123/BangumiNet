...
using System;
namespace BangumiNet.Api.P1.P1.Blogs.Item.Subjects
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\blogs\{entryID}\subjects
    /// </summary>
    ...
    public partial class SubjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// 获取日志的关联条目
        /// </summary>
        /// <returns>A List&lt;global::BangumiNet.Api.P1.Models.SlimSubject&gt;</returns>
...
#nullable enable
        public async Task<List<global::BangumiNet.Api.P1.Models.SlimSubject>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::BangumiNet.Api.P1.Models.SlimSubject>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Blogs.Item.Subjects.SubjectsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.P1.P1.Blogs.Item.Subjects.SubjectsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.P1.P1.Blogs.Item.Subjects.SubjectsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
