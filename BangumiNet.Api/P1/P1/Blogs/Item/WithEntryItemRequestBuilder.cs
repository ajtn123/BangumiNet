...
using BangumiNet.Api.P1.P1.Blogs.Item.Comments;
using BangumiNet.Api.P1.P1.Blogs.Item.Photos;
using BangumiNet.Api.P1.P1.Blogs.Item.Subjects;
...
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\blogs\{entryID}
    /// </summary>
...
#nullable enable
        public async Task<global::BangumiNet.Api.P1.Models.BlogEntry?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.P1.Models.BlogEntry> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.P1.P1.Blogs.Item.WithEntryItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.P1.P1.Blogs.Item.WithEntryItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
