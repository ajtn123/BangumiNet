...
using System;
namespace BangumiNet.Api.P1.P1.Me
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\me
    /// </summary>
...
#nullable enable
        public async Task<global::BangumiNet.Api.P1.Models.Profile?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.P1.Models.Profile> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Me.MeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.P1.P1.Me.MeRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.P1.P1.Me.MeRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
