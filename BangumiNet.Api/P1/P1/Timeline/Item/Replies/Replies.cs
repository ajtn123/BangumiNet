...
namespace BangumiNet.Api.P1.P1.Timeline.Item.Replies
{
    ...
    public partial class Replies : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::BangumiNet.Api.P1.Models.CommentBase>? RepliesProp { get; set; }
#nullable restore
#else
        public List<global::BangumiNet.Api.P1.Models.CommentBase> RepliesProp { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::BangumiNet.Api.P1.P1.Timeline.Item.Replies.Replies"/> and sets the default values.
        /// </summary>
        public Replies()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Timeline.Item.Replies.Replies"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::BangumiNet.Api.P1.P1.Timeline.Item.Replies.Replies CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::BangumiNet.Api.P1.P1.Timeline.Item.Replies.Replies();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "replies", n => { RepliesProp = n.GetCollectionOfObjectValues<global::BangumiNet.Api.P1.Models.CommentBase>(global::BangumiNet.Api.P1.Models.CommentBase.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::BangumiNet.Api.P1.Models.CommentBase>("replies", RepliesProp);
