...
#nullable restore
        ...
        /// 获取热门条目讨论
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::BangumiNet.Api.P1.Models.ErrorResponse">When receiving a 500 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsResponse?> GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsRequestBuilder.TopicsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsResponse> GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsRequestBuilder.TopicsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsResponse>(requestInfo, global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// 获取热门条目讨论
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class TopicsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsRequestBuilder.TopicsRequestBuilderGetQueryParameters>
        {
        }
    }
}
