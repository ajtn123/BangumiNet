...
namespace BangumiNet.Api.P1.P1.Trending.Subjects.Topics
{
    ...
    public partial class TopicsGetResponse : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::BangumiNet.Api.P1.P1.Trending.Subjects.Topics.TopicsGetResponse();
        }
