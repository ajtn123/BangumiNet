...
using System;
namespace BangumiNet.Api.P1.P1.Trending.Subjects
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\trending\subjects
    /// </summary>
    ...
    public partial class SubjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// 获取热门条目
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsGetResponse"/></returns>
...
#nullable enable
        public async Task<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsGetResponse?> GetAsSubjectsGetResponseAsync(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder.SubjectsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsGetResponse> GetAsSubjectsGetResponseAsync(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder.SubjectsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// 获取热门条目
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::BangumiNet.Api.P1.Models.ErrorResponse">When receiving a 500 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsResponse?> GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder.SubjectsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsResponse> GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder.SubjectsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsResponse>(requestInfo, global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// 获取热门条目
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder.SubjectsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder.SubjectsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder WithUrl(string rawUrl)
        {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SubjectsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::BangumiNet.Api.P1.P1.Trending.Subjects.SubjectsRequestBuilder.SubjectsRequestBuilderGetQueryParameters>
        {
        }
    }
}
