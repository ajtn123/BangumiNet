...
using BangumiNet.Api.P1.P1.Characters.Item;
...
namespace BangumiNet.Api.P1.P1.Characters
{
    ...
    public partial class CharactersRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::BangumiNet.Api.P1.P1.Characters.Item.WithCharacterItemRequestBuilder this[int position]
        {
            get
            {
        ...
        public global::BangumiNet.Api.P1.P1.Characters.Item.WithCharacterItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CharactersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/p1/characters", rawUrl)
        {
        }
    }
}
