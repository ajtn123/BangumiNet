...
namespace BangumiNet.Api.P1.P1.Characters.Item.Photos.Item.Comments
{
    ...
    public partial class Comments : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::BangumiNet.Api.P1.P1.Characters.Item.Photos.Item.Comments.Comments"/> and sets the default values.
        /// </summary>
        public Comments()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Characters.Item.Photos.Item.Comments.Comments"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::BangumiNet.Api.P1.P1.Characters.Item.Photos.Item.Comments.Comments CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::BangumiNet.Api.P1.P1.Characters.Item.Photos.Item.Comments.Comments();
        }
