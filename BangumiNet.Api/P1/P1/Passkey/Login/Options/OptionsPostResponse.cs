...
namespace BangumiNet.Api.P1.P1.Passkey.Login.Options
{
    ...
    public partial class OptionsPostResponse : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::BangumiNet.Api.P1.P1.Passkey.Login.Options.OptionsPostResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::BangumiNet.Api.P1.P1.Passkey.Login.Options.OptionsPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::BangumiNet.Api.P1.P1.Passkey.Login.Options.OptionsPostResponse();
        }
