...
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\subjects\{subjectID}\relations
    /// </summary>
    ...
    public partial class RelationsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// 获取条目的关联条目
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsGetResponse"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsResponse?> GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsRequestBuilder.RelationsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsResponse> GetAsync(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsRequestBuilder.RelationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsResponse>(requestInfo, global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// 获取条目的关联条目
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsRequestBuilder.RelationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsRequestBuilder.RelationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsRequestBuilder WithUrl(string rawUrl)
        {
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RelationsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::BangumiNet.Api.P1.P1.Subjects.Item.Relations.RelationsRequestBuilder.RelationsRequestBuilderGetQueryParameters>
        {
        }
    }
}
