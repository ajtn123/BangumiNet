...
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\episodes\{episodeID}\comments
    /// </summary>
    ...
    public partial class CommentsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// 获取条目的章节吐槽箱
        /// </summary>
        /// <returns>A List&lt;global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.Comments&gt;</returns>
...
#nullable enable
        public async Task<List<global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.Comments>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.Comments>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// 创建条目的章节吐槽
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsPostResponse"/></returns>
...
#nullable restore
        ...
        /// 创建条目的章节吐槽
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::BangumiNet.Api.P1.Models.ErrorResponse">When receiving a 429 status code</exception>
...
#nullable restore
        ...
        public async Task<global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsResponse> PostAsync(global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsResponse>(requestInfo, global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// 获取条目的章节吐槽箱
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.P1.P1.Episodes.Item.Comments.CommentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
