...
using System;
namespace BangumiNet.Api.P1.P1.Wiki.Recent.Persons
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\wiki\recent\persons
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class PersonsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::BangumiNet.Api.P1.P1.Wiki.Recent.Persons.PersonsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// 获取最近两天的人物wiki更新
        /// </summary>
        /// <returns>A List&lt;global::BangumiNet.Api.P1.P1.Wiki.Recent.Persons.Persons&gt;</returns>
        ...
        public async Task<List<global::BangumiNet.Api.P1.P1.Wiki.Recent.Persons.Persons>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::BangumiNet.Api.P1.P1.Wiki.Recent.Persons.Persons>(requestInfo, global::BangumiNet.Api.P1.P1.Wiki.Recent.Persons.Persons.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Wiki.Recent.Persons.PersonsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
