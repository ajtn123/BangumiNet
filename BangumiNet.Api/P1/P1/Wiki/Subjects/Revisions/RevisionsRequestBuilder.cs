...
using BangumiNet.Api.P1.P1.Wiki.Subjects.Revisions.Item;
...
namespace BangumiNet.Api.P1.P1.Wiki.Subjects.Revisions
{
    ...
    {
        /// <summary>Gets an item from the BangumiNet.Api.P1.p1.wiki.subjects.revisions.item collection</summary>
        ...
        public global::BangumiNet.Api.P1.P1.Wiki.Subjects.Revisions.Item.WithRevisionItemRequestBuilder this[int position]
        {
            get
            {
        ...
        public global::BangumiNet.Api.P1.P1.Wiki.Subjects.Revisions.Item.WithRevisionItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
