...
namespace BangumiNet.Api.P1.P1.Wiki.Subjects.Revisions.Item
{
    ...
    public partial class WithRevisionItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// 获取条目历史版本 wiki 信息
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.Models.SubjectRevisionWikiInfo"/></returns>
        ...
        public async Task<global::BangumiNet.Api.P1.Models.SubjectRevisionWikiInfo?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Wiki.Subjects.Revisions.Item.WithRevisionItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BangumiNet.Api.P1.P1.Wiki.Subjects.Revisions.Item.WithRevisionItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BangumiNet.Api.P1.P1.Wiki.Subjects.Revisions.Item.WithRevisionItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
