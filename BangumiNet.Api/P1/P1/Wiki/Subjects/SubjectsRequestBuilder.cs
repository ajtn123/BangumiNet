...
namespace BangumiNet.Api.P1.P1.Wiki.Subjects
{
    ...
    public partial class SubjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::BangumiNet.Api.P1.P1.Wiki.Subjects.Item.WithSubjectItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
...
#nullable enable
        public async Task<global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsPostResponse?> PostAsSubjectsPostResponseAsync(global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsPostResponse> PostAsSubjectsPostResponseAsync(global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// 创建新条目
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsResponse"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::BangumiNet.Api.P1.Models.ErrorResponse">When receiving a 400 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsResponse?> PostAsync(global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsResponse> PostAsync(global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsResponse>(requestInfo, global::BangumiNet.Api.P1.P1.Wiki.Subjects.SubjectsResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// 创建新条目
        /// </summary>
