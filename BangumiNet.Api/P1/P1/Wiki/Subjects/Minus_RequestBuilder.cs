...
using BangumiNet.Api.P1.P1.Wiki.Subjects.Characters;
using BangumiNet.Api.P1.P1.Wiki.Subjects.Persons;
using BangumiNet.Api.P1.P1.Wiki.Subjects.Relations;
...
namespace BangumiNet.Api.P1.P1.Wiki.Subjects
{
    ...
    public partial class Minus_RequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::BangumiNet.Api.P1.P1.Wiki.Subjects.Minus_RequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Minus_RequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/p1/wiki/subjects/-", pathParameters)
        {
        }
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Minus_RequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/p1/wiki/subjects/-", rawUrl)
        {
        }
    }
}
