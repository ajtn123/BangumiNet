...
namespace BangumiNet.Api.P1.P1.Wiki.Subjects.Item.HistorySummary
{
    ...
    public partial class HistorySummaryRequestBuilder : BaseRequestBuilder
    {
        ...
        /// 获取当前的 wiki 信息
        /// </summary>
        /// <returns>A List&lt;global::BangumiNet.Api.P1.Models.HistorySummary&gt;</returns>
...
#nullable enable
        public async Task<List<global::BangumiNet.Api.P1.Models.HistorySummary>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::BangumiNet.Api.P1.Models.HistorySummary>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::BangumiNet.Api.P1.Models.HistorySummary>(requestInfo, global::BangumiNet.Api.P1.Models.HistorySummary.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
