...
using System;
namespace BangumiNet.Api.P1.P1.Wiki.Users.Item.Contributions
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\wiki\users\{username}\contributions
    /// </summary>
    ...
    public partial class ContributionsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ContributionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/p1/wiki/users/{username}/contributions", rawUrl)
        {
        }
    }
}
