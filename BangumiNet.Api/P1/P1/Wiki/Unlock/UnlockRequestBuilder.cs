...
using BangumiNet.Api.P1.P1.Wiki.Unlock.Subjects;
...
using System;
namespace BangumiNet.Api.P1.P1.Wiki.Unlock
{
    /// <summary>
    /// Builds and executes requests for operations under \p1\wiki\unlock
    /// </summary>
    ...
    public partial class UnlockRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnlockRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/p1/wiki/unlock", rawUrl)
        {
        }
    }
}
