...
namespace BangumiNet.Api.P1.P1.Wiki.Characters.Item
{
    ...
    public partial class WithCharacterPatchRequestBody : IParsable
    {
        ...
        public global::BangumiNet.Api.P1.P1.Wiki.Characters.Item.WithCharacterPatchRequestBody_expectedRevision? ExpectedRevision { get; set; }

        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::BangumiNet.Api.P1.P1.Wiki.Characters.Item.WithCharacterPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::BangumiNet.Api.P1.P1.Wiki.Characters.Item.WithCharacterPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::BangumiNet.Api.P1.P1.Wiki.Characters.Item.WithCharacterPatchRequestBody();
        }
